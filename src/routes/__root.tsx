...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bullet Journal 2026 — Seu Life OS pessoal" },
      { name: "description", content: "Um journal digital cozy para hábitos, diário, mídia, metas e tudo o que vive em você." },
